...
exports.getAlternateLocales = exports.generateStructuredData = exports.getSEOContent = exports.seoContent = void 0;
exports.seoContent = {
    en: {
...
function getSEOContent(locale) {
    if (locale === 'pt-BR' || locale === 'pt')
        return exports.seoContent['pt-BR'];
    if (locale === 'pt-PT')
        return exports.seoContent['pt-PT'];
    return exports.seoContent.en;
}
...
function generateStructuredData(locale) {
    ...
    var localeCode = locale === 'pt-BR' || locale === 'pt' ? 'pt-BR' : locale === 'pt-PT' ? 'pt-PT' : 'en';
    var content = getSEOContent(localeCode);
    return {
...
function getAlternateLocales(currentLocale) {
    ...
    return locales.filter(function (l) { return l.locale !== currentLocale; });
}
exports.getAlternateLocales = getAlternateLocales;
