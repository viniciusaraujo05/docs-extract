...
function ApiIndex() {
    ...
    var _b = page.props, clients = _b.clients, flash = _b.flash;
    ...
    var baseApiUrl = window.location.origin + "/api/v1";
    ...
    return (React.createElement(app_layout_1["default"], { breadcrumbs: breadcrumbs },
        ...
        React.createElement("div", { className: "container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6" },
            React.createElement("div", { className: "space-y-6" },
                ...
                React.createElement(tabs_1.Tabs, { defaultValue: "getting-started", className: "space-y-6" },
                    React.createElement(tabs_1.TabsList, { className: "grid w-full grid-cols-4" },
                        React.createElement(tabs_1.TabsTrigger, { value: "getting-started" },
                            React.createElement(lucide_react_1.BookOpen, { className: "mr-2 h-4 w-4" }),
                            t('Getting Started')),
                        React.createElement(tabs_1.TabsTrigger, { value: "clients" },
                            React.createElement(lucide_react_1.Key, { className: "mr-2 h-4 w-4" }),
                            t('API Clients')),
                        React.createElement(tabs_1.TabsTrigger, { value: "docs" },
                            React.createElement(lucide_react_1.FileText, { className: "mr-2 h-4 w-4" }),
                            t('Documentation')),
                        React.createElement(tabs_1.TabsTrigger, { value: "security" },
