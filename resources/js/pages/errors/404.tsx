    ...
    return (
        <div className="flex min-h-screen flex-col bg-muted/30 text-foreground">
            ...
            <div className="flex flex-1 flex-col items-center justify-center px-4 py-16 text-center">
                ...
                <h2 className="mb-6 text-2xl font-semibold text-card-foreground sm:text-3xl">
                    Page not found
                </h2>
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-muted px-6 py-3 font-semibold text-foreground transition-colors hover:bg-muted"
                    >
                        Read our Blog
                    </Link>
                </div>
