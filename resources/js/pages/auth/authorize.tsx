...
export default function Authorize({ client, user, scopes, authToken, request }: AuthorizeProps) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen flex bg-background text-foreground items-center justify-center p-6 relative overflow-hidden">
                {/* Background effects */}
                ...
                >
                    <div className="bg-muted backdrop-blur-xl border border-border rounded-3xl p-8 lg:p-10 shadow-2xl">
                        ...
                        <div className="space-y-4 mb-10">
                            <h3 className="text-xs font-semibold text-muted-foreground flex items-center gap-2 uppercase tracking-widest">
                            ...
                            <div className="bg-muted border border-border rounded-2xl p-5 space-y-5">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Access to all your documents and data processing features.</p>
                                    </div>
                                </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <Button
                                variant="outline"
                                onClick={handleDeny}
                                className="h-14 bg-muted border-border hover:bg-muted text-foreground font-semibold rounded-2xl transition-all group"
                            >
                        ...
                        <div className="mt-8 pt-8 border-t border-border text-center">
                            <p className="text-xs text-muted-foreground flex items-center justify-center gap-2">
                                ...
                                Signed in as <span className="text-muted-foreground font-medium">{user.email}</span>
                            </p>
                        </div>
                    </div>
                </motion.div>
